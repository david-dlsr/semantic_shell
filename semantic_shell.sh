...
# VARIAVEIS GLOBAIS #
#####################
branch_atual="$(git b|grep ^*|awk '{print $2}')";
...
# Informar diretorio do projeto [S|s|Y|y]
...
*) echo "Sera usado o path atual: $PWD";;
esac

# configurando principais atalhos para o git no projeto
# git normal 
